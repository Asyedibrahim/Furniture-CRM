...
export default function AddCustomer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      for (let bill of customerData.bills) {
        if (!bill.billNo || !bill.amount || !bill.date) {
  ...
  return (
    <div className="container mx-auto p-4 md:bg-gray-100">
      <div className="bg-white sm:shadow-md rounded-lg sm:p-6">
